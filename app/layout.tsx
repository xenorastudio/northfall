...
const KEYWORDS = [
  ...
  'NorthFall مجتمع', 'NorthFall منتدى', 'NorthFall blog', 'NorthFall موقع', 'موقع NorthFall', 'NorthFall عربي', 'NorthFall Arabic', 'NorthFall gaming', 'NorthFall game dev', 'NorthFall تطوير ألعاب', 'NorthFall community', 'NorthFall forum', 'NorthFall platform', 'NorthFall عرب', 'NorthFall جيمر', 'NorthFall مطورين',
  ...
  'تطوير ألعاب بالعربي', 'تطوير العاب عربي', 'صناعة ألعاب عربية', 'صناعة العاب عربي', 'برمجة ألعاب بالعربي', 'برمجة العاب عربي', 'تصميم ألعاب عربي', 'تصميم العاب عربي', 'مطور ألعاب عربي', 'مطور العاب عربي', 'game development arabic', 'game developer arabic', 'game design arabic', 'game programming arabic',   'indie game dev arabic', 'indie developer عربي', 'indie game عربي', 'لعبة مستقلة عربية', 'مطور مستقل عربي', 'game jam عربي', 'هاكاثون ألعاب عربي', 'محرك ألعاب عربي', 'أفضل محرك ألعاب عربي', 'مقارنة محركات الألعاب عربي', 'ألعاب 2D عربي', 'ألعاب 3D عربي', 'ألعاب RPG عربي', 'ألعاب FPS عربي', 'ألعاب منصات عربي', 'ألعاب بلاتفورمر عربي', 'ألعاب استراتيجية عربي', 'ألعاب مغامرات عربي', 'ألعاب رعب عربي', 'ألعاب سباق عربي', 'ألعاب قتال عربي', 'ألعاب MMORPG عربي', 'ألعاب أونلاين عربي', 'نشر لعبة عربي', 'تسويق لعبة عربي', 'Steam عربي', 'نشر Steam عربي', 'App Store عربي', 'Google Play عربي',
  ...
  'كيف أصنع لعبة عربي', 'كيف أتعلم تطوير ألعاب عربي', 'من أين أبدأ تطوير ألعاب عربي', 'أفضل محرك ألعاب للمبتدئين عربي', 'كيف أنشر لعبة على Steam عربي', 'كيف أربح من الألعاب عربي',
  // Long-tail — very specific searches
  'كيفية صنع لعبة بالعربي خطوة بخطوة', 'تعلم برمجة الألعاب من الصفر بالعربي', 'أفضل محرك ألعاب للمبتدئين عربي 2024', 'أفضل محرك ألعاب للمبتدئين عربي 2025', 'صنع لعبة 2D بالعربي', 'صنع لعبة 3D بالعربي', 'صنع لعبة موبايل بالعربي', 'صنع لعبة أونلاين بالعربي',
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              (function() {
                try {
                  var saved = localStorage.getItem('nf-dark');
                  var isDark = saved === null || saved === 'true';
                  if (isDark) {
