...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "fs.trending": { ar: "شو رائج؟", en: "Trending?" },
  "fs.topNow": { ar: "الأوسم الآن", en: "Top Now" },
  // PostCard
  ...
  "gen.followers": { ar: "متابع", en: "followers" },
  "gen.followingCount": { ar: "متابَع", en: "following" },
  ...
  "cp.bodyPlaceholder": { ar: "نص المنشور (اختياري)", en: "Post text (optional)" },
