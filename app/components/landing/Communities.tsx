        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="space-y-4">
              {[
                { label: "Unity Community", desc: "Scripts, shaders, and 2D/3D workflows" },
                { label: "Unreal Engine Hub", desc: "Blueprints, C++, and AAA techniques" },
                { label: "Godot Corner", desc: "GDScript, nodes, and indie workflows" },
              ].map((item, i) => (
          ...
          <div className="relative">
            <div className="border border-white/[0.06] rounded-2xl bg-[#111] p-6">
              <div className="space-y-3">
                {[
                  { name: "Unity", members: "2.4k", posts: "340/week", color: "from-gray-500/20 to-gray-600/10" },
                  { name: "Unreal", members: "1.8k", posts: "210/week", color: "from-blue-500/20 to-blue-600/10" },
                  { name: "Godot", members: "960", posts: "150/week", color: "from-blue-400/20 to-blue-300/10" },
                  { name: "Blender", members: "1.2k", posts: "180/week", color: "from-orange-500/20 to-orange-400/10" },
                ].map((community, i) => (
                  <div key={i} className="p-4 rounded-xl border border-white/[0.06] hover:border-white/[0.12] transition-all cursor-pointer group bg-white/[0.02] hover:bg-white/[0.04]">
                    <div className="flex items-center gap-4">
                      <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${community.color} flex items-center justify-center font-semibold text-lg text-white/50`}>
                        {community.name[0]}
                      </div>
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-xs text-white/20">active posts</p>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="mt-6 pt-6 border-t border-white/[0.06] grid grid-cols-3 gap-4 text-center">
                <div>
                  <p className="text-2xl font-bold text-white/80">6.3k</p>
                  <p className="text-xs text-white/20">Total Members</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-white/80">4</p>
