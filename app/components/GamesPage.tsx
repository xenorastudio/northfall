...
export const GAMES: Game[] = [
  ...
  { id: "madden-24", name: "Madden NFL 24", cover: "/assets/GameCovor/Madden NFL 24.png", publisher: "EA", developer: "EA Tiburon", genre: ["رياضة", "محاكاة"], rating: 3.5, releaseYear: 2023, description: "كرة القدم الأمريكية الرسمية! فرق NFL حقيقية وأوضاع لعب متنوعة.", platforms: ["PC", "PS", "Xbox"], players: "1-6", steamUrl: "https://store.steampowered.com/app/2289808/Madden_NFL_24/" },
