          ...
          {activeSection === "account" && (
            <div className="space-y-6">
              ...
              <div className="p-4">
                ...
                {/* Banner */}
                <div className="relative h-[72px] rounded-xl overflow-hidden mb-4 border border-nf-border-2/50">
                ...
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-nf-border-2 shrink-0 bg-transparent">
                    {photoUrl || user?.photoURL ? (
                      <img src={photoUrl || user?.photoURL || ""} alt="" className="w-full h-full object-cover" />
                    ) : (
                      <div className="w-full h-full flex items-center justify-center text-lg font-bold text-nf-muted bg-nf-secondary/30">
                        {(displayName || "U")[0]}
                      </div>
                    )}
                  </div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <input type="url" value={photoUrl} onChange={e => setPhotoUrl(e.target.value)}
                      ...
                      className="w-full bg-transparent border border-nf-border-2 rounded-lg px-3 py-2 text-[12px] text-nf-text placeholder:text-nf-dim/50 outline-none focus:border-nf-accent/50 transition-colors" />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input type="text" value={displayName} onChange={e => setDisplayName(e.target.value)}
                      className="w-full bg-transparent border border-nf-border-2 rounded-lg px-3 py-2 text-[12px] text-nf-text outline-none focus:border-nf-accent/50 transition-colors" />
                  </div>
                  <div>
                    ...
                    <textarea value={bio} onChange={e => setBio(e.target.value)} maxLength={200} rows={3}
                      ...
                      className="w-full bg-transparent border border-nf-border-2 rounded-lg px-3 py-2 text-[12px] text-nf-text placeholder:text-nf-dim/50 outline-none focus:border-nf-accent/50 transition-colors resize-none" />
